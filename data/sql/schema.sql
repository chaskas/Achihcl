...
CREATE TABLE tema (id BIGINT AUTO_INCREMENT, first_post_id BIGINT NOT NULL, foro_id BIGINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by BIGINT, updated_by BIGINT, INDEX foro_id_idx (foro_id), INDEX first_post_id_idx (first_post_id), INDEX created_by_idx (created_by), INDEX updated_by_idx (updated_by), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE post ADD CONSTRAINT post_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id) ON DELETE CASCADE;
ALTER TABLE posts ADD CONSTRAINT posts_updated_by_sf_guard_user_id FOREIGN KEY (updated_by) REFERENCES sf_guard_user(id) ON DELETE CASCADE;
ALTER TABLE posts ADD CONSTRAINT posts_tema_id_tema_id FOREIGN KEY (tema_id) REFERENCES tema(id) ON DELETE CASCADE;
ALTER TABLE posts ADD CONSTRAINT posts_foro_id_foro_id FOREIGN KEY (foro_id) REFERENCES foro(id) ON DELETE CASCADE;
ALTER TABLE posts ADD CONSTRAINT posts_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id) ON DELETE CASCADE;
ALTER TABLE subcomision ADD CONSTRAINT subcomision_comision_id_comision_id FOREIGN KEY (comision_id) REFERENCES comision(id) ON DELETE CASCADE;
ALTER TABLE tema ADD CONSTRAINT tema_updated_by_sf_guard_user_id FOREIGN KEY (updated_by) REFERENCES sf_guard_user(id) ON DELETE CASCADE;
ALTER TABLE tema ADD CONSTRAINT tema_foro_id_foro_id FOREIGN KEY (foro_id) REFERENCES foro(id) ON DELETE CASCADE;
ALTER TABLE tema ADD CONSTRAINT tema_first_post_id_post_id FOREIGN KEY (first_post_id) REFERENCES post(id) ON DELETE CASCADE;
ALTER TABLE tema ADD CONSTRAINT tema_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id) ON DELETE CASCADE;
