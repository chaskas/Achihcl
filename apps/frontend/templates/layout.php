    ...
    <div id="centered">
      <div id="header">
        ...
        <ul id="navigation">
          ...
          <li <?php if($sf_context->getActionName()=='new' && $sf_context->getModuleName()=='membresia') echo "class='active'"; ?>><a href="<?php echo url_for('membresia/new'); ?>">Membres&iacute;a</a></li>
