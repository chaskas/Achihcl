...
abstract class BaseMiembroForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'celular_empresa'   => new sfWidgetFormInputText(),
      ...
      'subcomision'       => new sfWidgetFormInputText(),
      'cchrc'             => new sfWidgetFormInputCheckbox(),
    ));
    ...
    $this->setValidators(array(
      ...
      'cchrc'             => new sfValidatorBoolean(array('required' => false)),
    ));
